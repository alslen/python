...
def getPostData(post, jsonResult, cnt):
    ...
    jsonResult.append({'cnt':cnt, 'title':title, 'description':description, 'bloggername':bloggername, 'link':link, 'postdate':postdate})

node = 'blog'   # 'news'라는 탭에서
srcText = input('검색어를 입력하세요')  # '선거'를 찾기 위해서 선언
cnt = 0
jsonResult = []
